...
filtered_chunks = []   # We will store our filtered data here
chunk_num = 1
...
# --- THIS IS THE CHANGE: Reducing complexity to shrink the file size ---
# The original: model = RandomForestClassifier(n_estimators=100, random_state=42, n_jobs=-1)
model = RandomForestClassifier(
    n_estimators=25,     # Reduced from 100 to 25 to reduce file size
    max_depth=30,        # Limiting the depth also dramatically shrinks the size
    random_state=42, 
    n_jobs=-1
)
